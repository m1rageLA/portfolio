                ...
                {milestones.map((m, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span
                                className={`hidden md:block absolute h-px w-14 bg-white/30 top-1/2 -translate-y-1/2 ${isLeft ? "right-1/2" : "left-1/2"}`} />


                            {/* Text block */}
                            <div className={`relative max-w-md md:max-w-sm md:absolute ${isLeft
                                ? "md:right-[calc(50%_+_3.5rem)] md:text-right mr-4"
                                : "md:left-[calc(50%_+_3.5rem)]  md:text-left  ml-4"}`}>
