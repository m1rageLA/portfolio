...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
      <SectionNav />
      <main className="snap-y snap-mandatory scroll-smooth min-h-screen overflow-y-scroll">

        <section
          id="hero"
          className="snap-start flex flex-col min-h-screen px-4 md:px-[10%] py-10"
        >
        ...
        <section
          id="about"
          className="snap-start flex items-center justify-center min-h-screen px-4 md:px-[10%] py-20"
        >
        ...
        <section
          id="projects"
          className="snap-start flex flex-col items-center justify-center min-h-screen px-4 md:px-[10%] py-20"
        >
          <ProjectShowcase projects={projects} />
        </section>

        <section id="skills" className="snap-start flex flex-col items-center justify-center min-h-screen px-4 md:px-[10%] py-20">
          <SkillsTree />
        </section>

        <section id="contacts" className="snap-start flex flex-col items-center justify-center px-4 md:px-[10%] py-20 min-h-screen">
          <footer>
            <Footer />
          </footer>
        </section>
